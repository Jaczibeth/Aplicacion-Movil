    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.cardsContainer}>
        ...
        <Card style={styles.card} onPress={() => navigation.navigate('ListaAlumnos')}>
          ...
          <Card.Content>
            <Image 
              source={{ uri: 'https://cdn-icons-png.flaticon.com/512/3413/3413591.png' }} 
              style={styles.image} 
            />
          </Card.Content>
        </Card>
        ...
        <Card style={styles.card} onPress={() => navigation.navigate('RegistrarAlumno')}>
          ...
          <Card.Content>
            <Image 
              source={{ uri: 'https://cdn-icons-png.flaticon.com/512/3663/3663712.png' }} 
              style={styles.image} 
            />
          </Card.Content>
        </Card>
        ...
        <Card style={styles.card} onPress={() => navigation.navigate('EliminarAlumno')}>
          ...
          <Card.Content>
            <Image 
              source={{ uri: 'https://cdn-icons-png.flaticon.com/512/51/51418.png' }} 
              style={styles.image} 
            />
          </Card.Content>
        </Card>
        ...
        <Card style={styles.card} onPress={() => navigation.navigate('FiltrarCarrera')}>
          ...
          <Card.Content>
            <Image 
              source={{ uri: 'https://cdn-icons-png.flaticon.com/512/4151/4151225.png' }} 
              style={styles.image} 
            />
          </Card.Content>
        </Card>
